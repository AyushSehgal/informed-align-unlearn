#!/usr/bin/env python3
"""
LUNE Baseline Experiment — Mistral-7B on RWKU
...
def evaluate_all(model, tokenizer, data_dir):
    ...
    return {
        ...
        "GUR": compute_gur(model, tokenizer, data_dir),
...
def main():
    ...
    with open(metrics_file, "w") as f:
        f.write("epoch,loss,USR,GUR,APR,MIA\n")
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        with open(metrics_file, "a") as f:
            ...
            f.write(f"{epoch+1},{avg_loss},{usr},{gur},{apr},{mia}\n")
    ...
    forget_file = BATCH_DIR / "forget_level1.json"
